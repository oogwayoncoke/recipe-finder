...
export default function AuthForm({ initialMode = "login" }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Field-level errors stay inline; a generic non_field error goes to toast
      if (
        ...
        showToast(parsed.non_field_errors, "error");
        setErrors({});
      } else {
        setErrors(parsed);
      }
      ...
      <AuthPage>
        ...
        <Card>
          ...
          <div style={{ marginTop: "2rem", textAlign: "center" }}>
            ...
            <p style={{ ...TEXT.label, marginBottom: "0.75rem" }}>
              Check your email
            </p>
            <p
              style={{
            ...
            <GhostBtn onClick={() => switchMode("login")}>
              Back to login →
            </GhostBtn>
          </div>
        </Card>
  ...
  if (mode === "forgot") {
    return (
      <AuthPage>
        ...
        <Card>
          <Logo />
          <p style={{ ...TEXT.dim, marginBottom: "1.5rem" }}>
            // enter your email to reset
          </p>
          {forgotSent ? (
            <div style={{ textAlign: "center" }}>
              <p style={{ ...TEXT.label, marginBottom: "0.5rem" }}>
                Check your email
              </p>
              <p
                style={{
  ...
  return (
    <AuthPage>
      ...
      <Card>
        <Logo />
        <p style={{ ...TEXT.dim, marginBottom: "0" }}>
        ...
        >
          {googleLoading ? (
            <span style={TEXT.dim}>connecting…</span>
          ) : (
            <>
        ...
        {mode === "login" && (
          <div style={{ textAlign: "center", marginTop: "1rem" }}>
            <GhostBtn onClick={() => switchMode("forgot")}>
              Forgot password?
            </GhostBtn>
          </div>
        )}
